    ...
    def commentary(score0, score1):
        if who == 0:
            ...
            if gain > previous_high:
                print(gain,check_wording(gain), "That's the biggest gain yet for Player 0")
                return announce_highest(0, gain, score0)
            return announce_highest(0, previous_high, score0)
        elif who == 1:
            gain = score1 - previous_score
            if gain > previous_high:
                print(gain,check_wording(gain), "That's the biggest gain yet for Player 1")
                return announce_highest(1, gain, score1)
