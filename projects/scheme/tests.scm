...
;Problem 9
(lambda (c s a) (* c s 6 1 a))
; expect (lambda (c s a) (* c s 6 1 a))

(lambda (c a l) (+ c a l))
;expect (lambda (c a l) (+ c a l))
...
;Problem 11-12
(define (mult_two x) (* x 2))
; expect mult_two

(mult_two 3)
; expect 6

(define (make_list x y) (cons x (cons y nil)))
; expect make_list

(make_list 6 1)
; expect (6 1)

(define (mult_by x factor) (* x factor))
; expect mult_by

(mult_by 3 5)
; expect 15

(define (mult_make_list x y factor) (cons (mult_by x factor) (cons (mult_by y factor) nil)))
; expect mult_make_list

(mult_make_list 3 5 2)
; expect (6 10)
...
(define cs61a (lambda (c l) (cal (* c l))))
; expect cs61a

(define berkeley 5)
(define california 7)
(cs61a berkeley california)
; expect 245
