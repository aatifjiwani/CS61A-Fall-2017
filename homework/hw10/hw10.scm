...
(define (derive-exp exp var)
  (define b (base exp)) (define e (exponent exp))
  (if (number? e) (define power (make-sum n -1))
    (define first (make-product e (make-exp b power)))
      (make-product first (derive b var)) 'unkown'
  )
)
